...
export default class FTEPT93 extends Profile {
  profileSpec = {
    ...
    test: {
      ...
      fields:
        [{ eng: "study_field", fr: "رشته تحصیلی", value: "-" },] /* In case you want to get some additional fields and show in the profile */,
    },
